...
namespace OperaTools
{
	public class Program
	{
		...
		private static int Main(string[] args)
		{
			...
			try
			{
				ColoredConsole.WriteLine("~WOpera Speed Dial Patch 1.7.0~N");
				...
				OperaVersion[] operaVersions = new OperaVersion[]
				{
					...
					new OperaVersion(18, 0, 1271,   0,   18, 0, 1271,   0,    43020, 43515, 43026, 41010, 41008, new OperaExePatch(0x00015b1c, "0F 85 8A 00 00 00", "E9 8B 00 00 00 90", null)),
					new OperaVersion(18, 0, 1267,   0,   18, 0, 1267,   0,    43020, 43515, 43026, 41010, 41008, new OperaExePatch(0x0001583c, "0F 85 8A 00 00 00", "E9 8B 00 00 00 90", null)),
